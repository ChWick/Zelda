...
find_package_handle_standard_args(BULLET DEFAULT_MSG BULLET_LINEAR_MATH_LIB BULLET_H_PATH)
find_package_handle_standard_args(BULLET DEFAULT_MSG BULLET_DYNAMICS_LIB BULLET_H_PATH)
find_package_handle_standard_args(BULLET DEFAULT_MSG BULLET_COLLISION_LIB BULLET_H_PATH)
...
if (BULLET_FOUND)
    ...
    set (BULLET_LIBRARIES ${BULLET_LINEAR_MATH_LIB} ${BULLET_DYNAMICS_LIB} ${BULLET_COLLISION_LIB} ${BULLET_CONVEX_DECONPOSITION})
    if (BULLET_LIB_DBG)
