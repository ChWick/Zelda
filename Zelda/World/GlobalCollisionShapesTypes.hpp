...
enum EGlobalCollisionShapesTypes {
  ...
  GCST_PERSON_CAPSULE,
  GCST_HOUSE_ENTRANCE_TOP,
  GCST_HOUSE_ENTRANCE_SIDE,
  GCST_HOUSE_ENTRANCE,
  GCST_STONE_PILE_SINGLE_STONE,
  GCST_STONE_PILE,
  GCST_TREE,
...
class CGlobalCollisionShapesTypesIdMap
    : public CStringEnumIdMap<CGlobalCollisionShapesTypesIdMap,
                              EGlobalCollisionShapesTypes> {
public:
  void init();
};
