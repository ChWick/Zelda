...
const unsigned int MASK_STATIC_COLLIDES_WITH = COL_CHARACTER_N | COL_CHARACTER_P | COL_CAMERA | COL_DAMAGE_P | COL_DAMAGE_N | COL_INTERACTIVE;
const unsigned int MASK_INTERACIVE_OBJECT_COLLIDES_WITH = COL_CHARACTER_N | COL_CHARACTER_P | COL_DAMAGE_P;
